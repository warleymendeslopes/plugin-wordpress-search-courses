<?php
	...
	class Gamajo_Template_Loader {
		...
		/**
		 * Prefixo para nomes de filtros
		 *
		 * @since 1.0.0
		 *
		 * @var string
		 */
		protected $filter_prefix = 'search_plugin';

		/**
		 * Nome do diretório onde os modelos personalizados para este plug-in devem ser encontrados no tema.
		 *
		 * Por exemplo: 'your-plugin-templates'.
		 *
		 * @since 1.0.0
		 *
		 * @var string
		...
		/**
		 * Referência ao caminho do diretório raiz deste plug-in.
		 * Pode ser uma constante definida ou uma referência relativa de onde vive a subclasse.
		 *
		 ...
		 * @var string
		 */
		protected $plugin_directory = FILESEARCHPLUGIN;

		/**
		 * Nome do diretório onde os modelos são encontrados neste plug-in.
		 *
		...
		/**
		 * Retorne uma lista de caminhos para verificar os locais do modelo.
		 *
		...
		public function get_template_paths() {
			...
			$file_paths = array(
				10 => $this->get_templates_dir(),
				100  => trailingslashit( get_template_directory() ) . $theme_directory,
